...
See:
- **[DESIGN.md](DESIGN.md)** - Complete design document with architecture, analyses, and charts
- [CHUNK4_VERIFICATION.md](CHUNK4_VERIFICATION.md) - Container management verification
- [CHUNK5_VERIFICATION.md](CHUNK5_VERIFICATION.md) - Routing and health checks verification
- [CHUNK6_VERIFICATION.md](CHUNK6_VERIFICATION.md) - Docker Compose stack verification
- [CHUNK7_VERIFICATION.md](CHUNK7_VERIFICATION.md) - Load testing verification

## Documentation

- **[README.md](README.md)** - This file (quick start and usage)
- **[DESIGN.md](DESIGN.md)** - System design, architecture, performance analysis ⭐
...
**For ICS4104 students submitting this project:**

1. **📖 Read**: [SUBMISSION_GUIDE.md](SUBMISSION_GUIDE.md) - Complete step-by-step instructions
2. **⚡ Quick Start**: [QUICK_REFERENCE.md](QUICK_REFERENCE.md) - Essential commands
3. **✅ Generate Charts**: Run all analysis scripts (required!)
4. **🔗 GitHub**: Make repository PUBLIC
5. **🎥 Video**: Record 8-12 minute demonstration
...
python scripts/analysis_1_distribution.py
python scripts/analysis_2_scalability.py
python scripts/analysis_3_recovery.py
python scripts/analysis_4_hash_comparison.py

# Verify charts created
ls results/*.png  # Should show 5 PNG files
...
- ✅ Video demonstration (8-12 min)
- ✅ All 5 analysis charts in `results/`
- ✅ Complete documentation (README, DESIGN.md)
- ✅ All tests passing
